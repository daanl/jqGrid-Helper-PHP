...
class Grid
{
    ...
    */
    ...
    public function setPage($page)
    {
        ...
        {
            throw new Exception('Page not valid, not a number');
        }
    ...
    */
    public function setRowNum($rowNum)
    {
        if (!is_int($rowNum))
        {
            throw new Exception('RowNum not valid, not an int');
        }
        else if ($rowNum < -1)
        {
    ...
    */
    public function setRowNumWidth($rowNumWidth)
    {
        ...
        {
            throw new Exception('rowNumWidth not valid, not a number');
        }
    ...
    * You can also choose to use @see Grid::setScrollInt() to use scrolling while holding only the visible lines
    * in memory, to prevent memory leaks.
   ...
   /**
    * Creates dynamic scrolling grids, and keeps only the visible lines in memory.
  ...
  /**
    ...
    */
    public function setWidth($width)
    {
        if (!ctype_digit((string) $width))
        {
            throw new Exception('Width not valid, not a number');
        }
